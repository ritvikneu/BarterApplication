...
function NewHaveGoodRegistrationForm() {
    ...
    return (
        ...
        <h1 className='Heading2' >Add a NEED(Good)</h1>
        <form className='GoodForm' onSubmit={handleSubmitHaveGood}>


                <div className='FormElements'>
                {/* Title:  */}
                <label htmlFor="title">Title</label>
                <input className={"NewPostInput"} type="text" onChange={(e) => handleHaveGood(e)} id="title" value={data.title} placeholder='Title'/>
                </div>
            ...
            <label htmlFor="Brand">Brand</label>
                <input className="NewPostInput" type="text" onChange={(e) => handleHaveGood(e)} id="brand" value={data.brand} />
            ...
            <label htmlFor="description">Description</label>
                <textarea className="NewPostTextarea" onChange={(e) => handleHaveGood(e)} id="description" value={data.description} required></textarea>
        ...
        {/* <div id='UploadPic'>
                        <div>
                            <input className={"NewPostInput"} type="file" id="photo" onChange={(e) => handlePhoto(e)}>
                            </input>
            ...
            <label htmlFor="quantity">Quantity</label>
                <input className={"NewPostInput"} type="number" onChange={(e) => handleHaveGood(e)} id="quantity" value={data.quantity} required />

            </div>


            <div className='FormElements'>
            <label htmlFor="Mvalue">Valuation</label>
                <input className={"NewPostInput"} type="number" onChange={(e) => handleHaveGood(e)} id="estimateValue" value={data.estimateValue}/>
            </div>

            <div className='FormElements'>
            <label htmlFor="condition">Condition</label>
                <input className={"NewPostInput"} type="text" onChange={(e) => handleHaveGood(e)} id="condition" value={data.condition} required />
            </div>

            <div className='FormElements'>

            <label htmlFor="PostalCode">Postal Code</label>
                <input className={"NewPostInput"} type="text" onChange={(e) => handleHaveGood(e)} id="postalCode" value={data.postalCode} required />
            </div>


            <button style={{backgroundColor: '#50AEB3'}} className={"GoodSubmitButton"} type="submit" onClick={handleSubmitHaveGood}>Submit</button>
            </form>
            <ToastContainer />
