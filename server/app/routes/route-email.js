...
routeEmail.get('/emailId/:emailId', (req, res) => {
    ...
    const mailOptions = {
        ...
        to: emailId,
        subject: 'Barter App Trade Request',
        html: '<p>Hey!, a user is requesting to trade with your product on the Barter App. Checkout the App to complete the Trade :)</p>'
    };
